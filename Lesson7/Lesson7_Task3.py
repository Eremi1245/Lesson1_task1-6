...
class Cell():
    ...
    def __add__(self, other):
        ...
        return Cell(self.num_of_cell + other.num_of_cell) # Если нужен новы класс

    def __sub__(self, other):
        if self.num_of_cell > other.num_of_cell:
            return self.num_of_cell - other.num_of_cell
        else:
            return 'Невозможно выполнить вычитание, так как значение второго класса меньше первого '

    def __mul__(self, other):
        return self.num_of_cell * other.num_of_cell
        return Cell(self.num_of_cell * other.num_of_cell) # Если нужен новый Класс
    ...
    def __truediv__(self, other):
        try:
            ...
            return f'{Fail}, на ноль делить нельзя '

    def make_order(self, num_of_cell_in_row):
        return ('/n').join(['*' * num_of_cell_in_row] * (self.num_of_cell // num_of_cell_in_row) + [
